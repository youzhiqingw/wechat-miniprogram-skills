...
- [开发者工具 CLI 命令行工具](https://developers.weixin.qq.com/miniprogram/dev/devtools/cli.html)
- [开发者工具自动化测试](https://developers.weixin.qq.com/miniprogram/dev/devtools/auto/miniprogram.html)
...
- [服务端消息推送](https://developers.weixin.qq.com/miniprogram/dev/framework/server-ability/message-push.html)
- [网络请求与域名配置](https://developers.weixin.qq.com/miniprogram/dev/framework/ability/network.html)
- [小程序备案指引](https://developers.weixin.qq.com/miniprogram/dev/framework/record.html)
- [用户隐私保护指引](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/privacy.html)
- [路由与页面导航](https://developers.weixin.qq.com/miniprogram/dev/framework/app-service/route.html)
- [组件系统](https://developers.weixin.qq.com/miniprogram/dev/component/)

### 服务端 API（已验证）
- [服务端 API 目录](https://developers.weixin.qq.com/miniprogram/dev/api-backend/)
- [code2Session](https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/login/auth.code2Session.html)
- [内容安全（msgSecCheck）](https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/sec-check/security.msgSecCheck.html)

### UI 组件库

| 组件库 | 适用场景 | 官方链接 |
|--------|---------|---------|
| **WeUI** | 追求微信原生视觉、快速搭建基础页面 | [微信官方文档](https://developers.weixin.qq.com/miniprogram/dev/platform-capabilities/extended/weui/) / [GitHub](https://github.com/wechat-miniprogram/weui-miniprogram) / [快速开始](https://wechat-miniprogram.github.io/weui/docs/quickstart.html) |
| **TDesign** | 企业级应用、多端统一、高定制需求 | [官网](https://tdesign.tencent.com/) / [小程序版 GitHub](https://github.com/Tencent/tdesign-miniprogram) |
| **CloudBase Agent UI** | 快速集成 AI 对话能力 | [官方文档](https://docs.cloudbase.net/ai/agent-ui/agent-ui-mp) / [GitHub](https://github.com/TencentCloudBase/cloudbase-agent-ui) |

**安装示例：**
```bash
# WeUI（推荐扩展库引入，不占用包体积）
# 在 app.json 中添加："useExtendedLib": { "weui": true }
